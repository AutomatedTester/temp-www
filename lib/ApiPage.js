...
module.exports = class ApiPage {
  ...
  async writeApiMethodPages(content) {
    ...
    const templateData = await Utils.readFile(ApiPage.apiMethodPageTemplateFile);
  ...
  writeApiMethod({fileData, templateData, headerTemplateData, content, fileName}) {
    ...
    const methodData = swig.renderFile(ApiPage.apiMethodPage, {
      method: fileData
    });
